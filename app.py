...
app = Flask(__name__)
CORS(app, resources={r"/send-email": {"origins": "https://frontend-b2bfpjw6h-frontends-projects-1701b574.vercel.app"}}, supports_credentials=True)
...
def send_email():
    ...
    # ✅ Updated HTML with message inside the table
    html = f"""
    <html>
      <body style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px;">
        <div style="max-width: 600px; margin: auto; background-color: #fff; padding: 30px; border: 1px solid #ddd; border-radius: 10px;">
          ...
          <h2 style="color: #007BFF;">📋 Your Business Setup Plan Summary</h2>

          <p style="margin-bottom: 30px;">
            Dear {name},<br><br>
            Thank you for reaching out to <strong>YourCompanyName</strong>. We’ve received your inquiry and our team will review your information shortly.<br>
          ...
          <table style="width: 100%; border-collapse: separate; border-spacing: 10px;">
            ...
            <tr><td><strong>🏷 Recommended Plan:</strong></td><td>{plan}</td></tr>
            ...
            <tr>
              <td colspan="2" style="padding-top: 20px; border-top: 1px solid #ddd; font-style: italic;">
                ☎️ Our team will reach out to you soon to take this forward. You can also reply to this email directly.
              </td>
            </tr>
          </table>

          <p style="font-size: 12px; color: #888; border-top: 1px solid #ddd; margin-top: 30px; padding-top: 10px;">
            This message was generated by YourCompanyName.com. If you didn’t request this, please ignore.
          </p>
    ...
    msg['Subject'] = "📋 Your Business Setup Plan Summary"
